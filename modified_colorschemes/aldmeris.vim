...
" Modification to the original colorscheme, remove the following and uncomment next line if you prefer the original colorscheme
call s:Hi( 'Statement',    s:aluminium6,   s:chameleon1,   "bold" )
